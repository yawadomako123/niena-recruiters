                ...
                <div className="text-center max-w-4xl mx-auto animate-fade-in-up">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4">
                        <Link
                            ...
                            className="w-full sm:w-auto bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg hover:shadow-xl transition-all hover:-translate-y-1"
                        >
                            Apply as Recruiter →
                        </Link>
                        <Link
                            href="#features"
                            className="w-full sm:w-auto bg-white border-2 border-gray-200 text-gray-900 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg hover:border-gray-300 transition-all hover:shadow-lg"
                        >
                            Learn More
                        </Link>
                    </div>
